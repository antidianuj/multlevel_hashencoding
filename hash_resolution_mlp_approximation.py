...
if __name__ == "__main__":
    ...
    parser.add_argument('--channel_size', type=int, default=1, help='Number of Total Feature Dimension/3')
    parser.add_argument('--hidden_dim', type=int, default=100, help='Hidden Dimension of the MLP')
    parser.add_argument('--lr', type=float, default=0.001, help='Learning Rate for the MLP')
